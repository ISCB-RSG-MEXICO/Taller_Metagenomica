...
2.  Después de que aparezca una ventana emergente en tu pantalla, selecciona la opción **“Select file” (Seleccionar archivo)**.
    ...
    ![Select filed button highlighted in the emergent window](https://carpentries-lab.github.io/metagenomics-shell/fig/02-05-09.png){alt="Select filed button highlighted in the emergent window" width="1199"}
