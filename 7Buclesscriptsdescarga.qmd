...
# **Escritura de scripts y trabajo con datos (yahir)**

# Escribir y editar archivos con Nano
...
1.  Choose the option ‘Upload’ in your RStudio interface.[![The Upload button is highlighted.](https://carpentries-lab.github.io/metagenomics-shell/fig/02-05-08.png){alt="The Upload button is highlighted."}](https://carpentries-lab.github.io/metagenomics-shell/fig/02-05-08.png)

2.  After an emergent window is displayed on your screen, select “Select file”.[![Select filed button highlighted in the emergent window](https://carpentries-lab.github.io/metagenomics-shell/fig/02-05-09.png){alt="Select filed button highlighted in the emergent window"}](https://carpentries-lab.github.io/metagenomics-shell/fig/02-05-09.png)

3.  A new screen is displayed on your computer where you should choose the file to upload. Choose the file and click “open”.[![file to upload and open button are highlighted in the window of the local filesystem](https://carpentries-lab.github.io/metagenomics-shell/fig/02-05-10.png){alt="file to upload and open button are highlighted in the window of the local filesystem"}](https://carpentries-lab.github.io/metagenomics-shell/fig/02-05-10.png)
...
## Transferir archivos entre tu máquina local y la instancia remota con `scp`

`scp` (“secure copy protocol”) te permite copiar archivos de forma segura entre dos ordenadores (local ↔ remoto).
...
Para especificar una máquina remota usas el formato `usuario@host:/ruta/al/archivo`.
