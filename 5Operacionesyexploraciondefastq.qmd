...
![Cuando estés dentro de `less` y quieras buscar un texto, haz esto:](images/clipboard-2423031106.png){alt="Cuando estés dentro de less y quieras buscar un texto, haz esto:"}
